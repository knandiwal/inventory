cordova.define("cordova/plugin/barcodeScanner", function(require, exports, module) {
    ...
    BarcodeScanner.prototype.isBarcodeScannerAvailable = function(response){
        exec(response, null, "BarcodeScanner", "isBarcodeScannerAvailable", []);
    };

    BarcodeScanner.prototype.isBarcodeScannerSetup = function(response){
        exec(response, null, "BarcodeScanner", "isBarcodeScannerSetup", []);
    };
    ...
    BarcodeScanner.prototype.scan = function(success, fail, options) {
        ...
        if ( null == options )
            ...
            return exec(successWrapper, fail, "BarcodeScanner", "scan", options)
        }
    ...
    BarcodeScanner.prototype.encode = function(type, data, success, fail, options) {
        ...
        return exec(success, fail, "BarcodeScanner", "encode", [{type: type, data: data, options: options}])
    };
